...
//    public static function errores_precio_maximo($cadena = null) {
//        $mensaje = null; // Optimista
//
//        if (!is_null($cadena) && strlen($cadena)) {
//            $patron = "/^(\d{1,3}){1}(\.\d{1,2}){0,1}$/i";
//            if (!preg_match($patron, $cadena))
//                $mensaje = "-php- Error: El número debe escribirse con separador de decimales(.) y no ser superior a 999.99";
//        }
//        return $mensaje;
//    }
